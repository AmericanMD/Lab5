...
public class Calculator
{
    ...
    public static String parseAndExecute(String input)
    {
        ...
        catch(CalculatorException calcProb) {
        	return "Calculator Exception, message is: " + calcProb.getMessage();
        }
        catch(NumberFormatException numProb) {
        	return "Input number cannot be parsed to an int. Please try again.";
        }
        catch(ArithmeticException statementProb) {
        	return "Attempt to divide by 0. Please try again";
        }
